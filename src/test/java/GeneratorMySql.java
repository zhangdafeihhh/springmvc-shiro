...
//        Configuration config = cp.parseConfiguration(GeneratorMySql.class.getClassLoader().getResourceAsStream("generatorConfig-mdbcarmanage.xml"));
        ...
        //指定 逆向工程配置文件
        File configFile = new File("D:\\git\\mp\\mp-manage\\src\\test\\java\\generatorConfig-rentcar.xml");
//        File configFile = new File("D:\\git\\mp\\mp-manage\\src\\test\\java\\generatorConfig-mdbcarmanage.xml");
