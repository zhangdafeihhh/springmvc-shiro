...
/**
 */
public class UsernamePasswordMsgcodeRealm extends AuthorizingRealm {
    private static final Logger logger = LoggerFactory.getLogger(UsernamePasswordMsgcodeRealm.class);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException{
        ...
        return new SimpleAuthenticationInfo("aaa","111111" ,  this.getName() );
