...
public class BusConstant {
    ...
    public interface Order{
        String[] ORDER_HEAD=  {"订单ID", "订单号", "下单时间", "预定用车时间", "预约上车地点", "预约下车地点", "城市", "服务类别", "预约车型类别","实际车型类别", "订单类别", "乘车人数量", "行李数数量", "预定人手机号", "乘车人", "乘车人手机号", "车牌号", "完成时间", "实际上车时间", "实际上车地点", "实际下车地点", "单程/往返", "状态", "取消原因", "总支付金额", "预收费用", "代收费用", "违约金额", "优惠金额", "供应商", "订单来源", "预订人", "实际里程", "实际时长", "预收支付方式", "代收支付方式", "司机姓名", "司机手机号", "停车费", "高速费", "住宿费", "餐饮费", "其他费", "预付费支付时间", "代收费支付时间", "指派时间", "改派时间", "订单评分","企业名称", "付款类型", "企业折扣"};
    }
