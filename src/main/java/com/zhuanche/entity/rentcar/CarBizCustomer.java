...
public class CarBizCustomer {
    ...
    private Date bindingCardDate;

    private String bankid;

    private Byte isUsedAccount;
    ...
    public Date getBindingCardDate() {
        return bindingCardDate;
    }

    public void setBindingCardDate(Date bindingCardDate) {
        this.bindingCardDate = bindingCardDate;
    }
    ...
    public Byte getIsUsedAccount() {
        return isUsedAccount;
    }

    public void setIsUsedAccount(Byte isUsedAccount) {
        this.isUsedAccount = isUsedAccount;
    }
