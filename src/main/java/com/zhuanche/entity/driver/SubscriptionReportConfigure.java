...
public class SubscriptionReportConfigure {
    private Long id;
    ...
    private Integer subscriptionCycle;
    ...
    public Integer getSubscriptionCycle() {
        return subscriptionCycle;
    }

    public void setSubscriptionCycle(Integer subscriptionCycle) {
