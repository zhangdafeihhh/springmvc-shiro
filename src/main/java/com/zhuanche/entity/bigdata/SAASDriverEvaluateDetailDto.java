...
public class SAASDriverEvaluateDetailDto implements Serializable {
    ...
    public String getMotorcardName() {
        return this.motorcardName;
    }

    public String getDriverEvaluateText() {
        return this.driverEvaluateText;
    }
    ...
    public String getEvaluateCustomerId() {
        return this.evaluateCustomerId;
    }
    ...
    public String getActualOnboardLocation() {
        return this.actualOnboardLocation;
    }

    public String getActualDebusLocation() {
        return this.actualDebusLocation;
    }
