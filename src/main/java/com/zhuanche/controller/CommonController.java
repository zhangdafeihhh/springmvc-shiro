...
public class CommonController {
    ...
    */
    ...
    public AjaxResponse carBizModelList(){
        ...
        List<CarBizModel> carBizModels = carBizModelService.queryCarBizModelNoPage();
    ...
    public AjaxResponse queryGroup() {
        ...
        // 查询用车类别
        CarBizCarGroup entity = new CarBizCarGroup();
        entity.setType(1);
        List<CarBizCarGroup> list = carBizCarGroupService.queryForListObject(entity);
