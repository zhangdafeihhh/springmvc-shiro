...
public class SupplierFeeController {
    ...
    public AjaxResponse exportSupplierFeeData(HttpServletResponse response,HttpServletRequest request,
        ...
        try {
            ...
            String titles = "供应商ID,合作商全称,合作商,这列为空,结算开始日期,结算结束日期,总营业额,入围司机营业额,流水金额,风控金额,价外费,取消费,流水合计金额,规模系数,上月总流水,上月运营车辆数,运营车辆增幅,流水增幅,增长系数,司机贡献金合计," +
    ...
    private List<String> footerList(List<String> footerList){
        ...
        footerList.add("\n");
        footerList.add("邮寄地址:");
        footerList.add("北京市朝阳区武圣东路松榆东里37号楼 首开梦想加空间 首汽约车");
