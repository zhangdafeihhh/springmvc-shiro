 ...
 * @Author fanht
 * @Description
 * @Date 2019/4/18 下午2:58
 * @Version 1.0
 */
public class ExcelProducerDouble {
    private static final Logger logger = LoggerFactory.getLogger(ExcelProducerDouble.class);
    ...
    public void init() throws MQClientException {
        ExcelProducerDouble.startProducer( this.namesrvAddr );
    }
    ...
    /**销毁生产者**/
    public void destroy() {
        ExcelProducerDouble.stopProducer();
    }
