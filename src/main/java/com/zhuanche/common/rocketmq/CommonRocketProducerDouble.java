 ...
 * @author zhaoyali
 **/
public class CommonRocketProducerDouble {
	private static final Logger logger = LoggerFactory.getLogger(CommonRocketProducerDouble.class);
	...
	public void init() throws MQClientException{
		CommonRocketProducerDouble.startProducer( this.namesrvAddr );
	}
	...
	/**销毁生产者**/
	public void destroy() {
		CommonRocketProducerDouble.stopProducer();
	}
