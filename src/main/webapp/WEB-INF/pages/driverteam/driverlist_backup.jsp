...
<html>
<head>
  <link rel="stylesheet" href="${webctx}/resources/layui/css/layui.css?v=${staticResourceVersion}"  media="all">
</head>
<body>
...
<script src="${webctx}/resources/layui/layui.js?v=8800" type="text/javascript"></script>
<script>
